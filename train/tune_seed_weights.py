...
def main():
    ...
    # save weights
    pd.DataFrame({"seed": SEEDS, "weight": best_w}).to_csv("result9(537)/weights_seed_ensemble.csv", index=False)
    ...
    np.save("result9(537)/oof_proba_cat_weighted.npy", oof_best)
    np.save("result9(537)/test_proba_cat_weighted.npy", test_best)
