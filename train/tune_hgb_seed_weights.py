...
def main():
    ...
    # Save arrays
    np.save("result9(537)/oof_proba_hgb_weighted.npy", oof_w)
    np.save("result9(537)/test_proba_hgb_weighted.npy", test_w)
    np.save("result9(537)/oof_proba_hgb_weighted_ts.npy", oof_ts)
    np.save("result9(537)/test_proba_hgb_weighted_ts.npy", test_ts)
